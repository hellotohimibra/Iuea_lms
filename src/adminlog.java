...
public class adminlog extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel4.getAccessibleContext().setAccessibleName("ADMINISTRATION LOGIN");
    ...
    private void loginActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_loginActionPerformed
        try{
                ...
                String sql = "SELECT * FROM adminlog WHERE username='"+userEmail+"' && password='"+userPass+"'";
                rs=stmt.executeQuery(sql);
                if(rs.next()){
                    setVisible(false);
                    admin_home object =new admin_home();
