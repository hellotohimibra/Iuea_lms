...
public class registerdstuddents extends javax.swing.JFrame {
        //CREATING VARIABLES FOR CONNECTION
                Connection conn;
                ResultSet rs;
                PreparedStatement pst;
   
    public registerdstuddents() {
        initComponents();
     ...
     String sql = "select *  from student where id LIKE ? ||  phone LIKE ? ";
    try{
    ...
    { JOptionPane.showMessageDialog(null, e); }
                     ...
                     public void update(){
                     String search= searchbox1.getText();
     String sql = "delete from student where id= ? ";
    try{
    pst= conn.prepareStatement(sql);
    pst.setString(1, search);
    int YN = JOptionPane.showConfirmDialog(null, "Are you sure you want to delete?", "Delete Student", JOptionPane.YES_NO_OPTION);
        if(YN==0){
              pst.executeUpdate();
        }
     jTable1();
    ...
    private void initComponents() {
        ...
        jLabel7.setText("Search Student by ID/Phone:");
        ...
        jLabel8.setFont(new java.awt.Font("Tekton Pro", 1, 12)); // NOI18N
        jLabel8.setForeground(new java.awt.Color(153, 0, 0));
        jLabel8.setText("Enter Student ID to delete");
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(searchbox1, javax.swing.GroupLayout.PREFERRED_SIZE, 170, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addGap(95, 95, 95)
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(registerdstuddents.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
